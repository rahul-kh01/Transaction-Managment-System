...
const keyFeatures = [
  {
    ...
    description:
      "Lightning-fast barcode scanning with instant product lookup and billing",
  },
  {
  ...
  {
    icon: <FiUser className="w-8 h-8" />, // ✅ Fixed typo: removed stray 's'
    title: "Customer & Employee Profiles",
    description:
      "Comprehensive profiles for customers and role-based employee management",
  },
  {
    icon: <FiShield className="w-8 h-8" />,
    title: "Role-Based Access Control",
    description:
      "Secure access control with customizable permissions for different staff roles",
  },
  {
    icon: <FiFileText className="w-8 h-8" />,
    title: "Sales Reporting",
    description:
      "Detailed analytics and reports to track performance and growth",
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Our comprehensive POS system includes all the features modern
