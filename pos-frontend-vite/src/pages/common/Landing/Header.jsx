...
const GithubIcon = ({ className = "w-10 h-10" }) => (
  <div
    className={`relative inline-flex items-center justify-center rounded-full p-2.5 
  ...
  >
    <svg
      ...
      className="w-6 h-6 text-gray-800 dark:text-gray-100 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors duration-300"
    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              >
                <GithubIcon className="w-11 h-11 text-white group-hover:text-primary transition-colors" />
              </a>
              <ThemeToggle />
